...
This presentation is not a collection of slides. It is a story.
Every section builds on the last. The arc creates a psychological journey
from curiosity → excitement → confidence → action.

## Section 1: Opening (1-2 slides)
**Goal:** Establish credibility and connection. Create intrigue.
**NOT:** "Here's our company." Instead: something that signals we understand their world.
**Key signal:** We've done our homework. We respect who they are.
...
**Goal:** Answer objections before they become questions. Make it safe.
**Include:** Regulatory status, risk mitigation, environmental approach, team credentials.
**Key:** "We've already thought about everything you're about to ask."
**Source docs:** 04-risk-mitigation.md
...
**Goal:** Clear, direct, respectful. What we're requesting and what happens next.
**NOT vague:** "Let's talk." Instead: A specific next step with a timeline.
**Tone:** Confident. We've earned the right to ask.

## Total: 15-20 slides maximum. Every slide earns its place.
